...
{
    internal class TeamFoundationServerWorkItemDataProviderInternal : IDataPull<WorkItem>
    {
        public TeamFoundationServerWorkItemDataProviderInternal(Uri tfsConnectionString, string projectName)
        {
